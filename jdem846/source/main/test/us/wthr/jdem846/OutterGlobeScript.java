...
import us.wthr.jdem846.GlobeScript.LayerRenderThread;
import us.wthr.jdem846.GlobeScript.RenderMethod;
...
public class OutterGlobeScript implements ScriptProxy
{
	...
	{
		oceanGlobeScript = new GlobeScript(true, false, false, false, false);
			...
			throws ScriptingException
	{
		...
		OnProcessAfterThread[] threads = new OnProcessAfterThread[5];
