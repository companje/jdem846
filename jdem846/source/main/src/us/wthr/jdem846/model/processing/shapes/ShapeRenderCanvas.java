...
public class ShapeRenderCanvas
{
	private static Log log = Logging.getLog(ShapeRenderCanvas.class);
	...
	public void fillTriangle(int[] color, double latitude0, double longitude0, double elevation0, double latitude1, double longitude1, double elevation1, double latitude2, double longitude2, double elevation2) throws CanvasException
	{
		pathBuffer.reset();
	 ...
	 * @param elevation
	 */
	public void fillRectangle(int[] color, double latitude, double longitude, double width, double height, double elevation) throws CanvasException
	{
	 ...
	 * @param elevation
	 */
	public void drawRectangle(int[] color, double latitude, double longitude, double width, double height, double elevation) throws CanvasException
	{
		__drawRectangle(color, latitude, longitude, width, height, elevation, false);
	}

	private void __drawRectangle(int[] color, double latitude, double longitude, double width, double height, double elevation, boolean fill) throws CanvasException
	{
		double row0, row1;
	...
	protected void drawRectangleSimpleStandard(int[] color, double row0, double column0, double row1, double column1, boolean fill)
	{
		// color[3] = 0xFF;
	...
	protected void drawRectangleSimpleAntialiased(int[] color, double row0, double column0, double row1, double column1, boolean filled)
	{
		int alpha = 255;
		if (color.length >= 4) {
			alpha = color[3];
	...
	public void drawLine(int[] color, double lat0, double lon0, double elev0, double lat1, double lon1, double elev1) throws CanvasException
	{
		double row0, row1;
		double column0, column1;
	...
	public void fillRectangle(int[] color, double lat0, double lon0, double elev0, double lat1, double lon1, double elev1, double lat2, double lon2, double elev2, double lat3, double lon3, double elev3) throws CanvasException
	{
		pathBuffer.reset();
	...
	public void drawImage(Image image, double north, double south, double east, double west) throws CanvasException
	{
		...
		// ImageUtilities.getScaledInstance((BufferedImage)image, width, height,
	...
	public Image getSubImage(double north, double south, double east, double west) throws CanvasException
	{
		...
		graphics.setRenderingHint(RenderingHints.KEY_COLOR_RENDERING, RenderingHints.VALUE_COLOR_RENDER_QUALITY);
		// if
		// (modelContext.getModelOptions().getBooleanOption(ModelOptionNamesEnum.ANTIALIASED))
		// {
		graphics.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
		// }
		graphics.drawImage(image, 0, // int dx1,
				0, // int dy1,
				width, // int dx2,
				height, // int dy2,
				srcX, // int sx1,
	...
	public Image getFinalizedImage(boolean applyBackground)
	{
		...
		// BufferedImage finalImage = ImageUtilities.getScaledInstance(image,
		// getWidth(), getHeight(), RenderingHints.VALUE_INTERPOLATION_BILINEAR,
		// false);
		//if (isAntiAliased) {
