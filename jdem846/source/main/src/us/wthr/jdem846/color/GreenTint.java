...
@DemColoring(name="us.wthr.jdem846.color.greenTint.name"
			, identifier="green-tint"
			, allowGradientConfig=false
			, needsMinMaxElevation=false)
public class GreenTint extends SingleColorTinting
{

	public GreenTint()
	{
		super(new Color(146, 173, 144, 255));
	}
