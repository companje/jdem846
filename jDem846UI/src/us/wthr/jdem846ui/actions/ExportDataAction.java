...
public class ExportDataAction extends Action {
	...
	public ExportDataAction(IWorkbenchWindow window, String label, String viewId)
	{
		...
		setId(ICommandIds.CMD_EXPORT_DATA);
        // Associate the action with a pre-defined command, to allow key bindings.
		setActionDefinitionId(ICommandIds.CMD_EXPORT_DATA);
		setImageDescriptor(Activator.getImageDescriptor("/icons/eclipse/data_export.gif"));
	}
}
