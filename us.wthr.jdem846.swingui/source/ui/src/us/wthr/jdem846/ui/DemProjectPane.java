...
public class DemProjectPane extends JdemPanel implements Savable
{
	...
	protected void initialize(ProjectMarshall projectMarshall)
	{
		...
		try {
			modelContext = ModelContext.createInstance(rasterDataContext, shapeDataContext, imageDataContext, null, modelProcessManifest, scriptingContext);
		...
		visualizationPanel.addProjectionChangeListener(new ProjectionChangeListener()
		{
			public void onProjectionChanged(double rotateX, double rotateY, double rotateZ, double shiftX, double shiftY, double shiftZ, double zoom)
			{
				...
				ViewPerspective viewAngle = new ViewPerspective(rotateX, rotateY, rotateZ, shiftX, shiftY, shiftZ, zoom);
	...
	public void initializeScripting(ProjectMarshall projectMarshall)
	{
		...
		// /if (modelOptions.getUserScript() != null &&
		// modelOptions.getUserScript().length() > 0) {
		// return;
		// }
		...
		if (projectMarshall != null && projectMarshall.getUserScript() != null && projectMarshall.getUserScript().length() > 0) {
			...
			try {
				...
				JOptionPane.showMessageDialog(getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.scripting.loadTemplateFailure.message"), I18N.get("us.wthr.jdem846.ui.projectPane.scripting.loadTemplateFailure.title"), JOptionPane.ERROR_MESSAGE);
				return;
			}
	...
	protected void openInputData()
	{
		...
		// for (ElevationDataLoaderInstance instance :
		// ElevationDataLoaderRegistry.getInstances()) {
		// FileNameExtensionFilter filter = new
		// FileNameExtensionFilter(instance.getName(), instance.getExtension());
	...
	protected void applyOptionsToUI()
	{
		...
		/*
		 * scriptPane.setScriptLanguage(scriptingContext.getScriptLanguage());
		 * if (scriptingContext.getUserScript() != null &&
		 * scriptingContext.getUserScript().length() > 0) {
		 * scriptPane.setScriptContent(scriptingContext.getUserScript()); }
		 */
	...
	protected void removeInputData(int type, int index)
	{
		try {
			...
			JOptionPane.showMessageDialog(getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.remove.removeError.message"), I18N.get("us.wthr.jdem846.ui.projectPane.remove.removeError.title"), JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	protected void addShapeDataset(String filePath, String shapeDataDefinitionId, boolean triggerModelChanged)
	{
		try {
			...
			JOptionPane.showMessageDialog(getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.add.shapefile.loadFailed.message") + ": " + ex.getMessage(), I18N.get("us.wthr.jdem846.ui.projectPane.add.shapefile.loadFailed.title"),
					JOptionPane.ERROR_MESSAGE);
		}
	...
	protected void addImageryData(String filePath, double north, double south, double east, double west, boolean triggerModelChanged)
	{
		...
		try {
			...
			JOptionPane.showMessageDialog(this.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.add.image.loadFailed.message") + ": " + "", // ex.getExtension(),
					I18N.get("us.wthr.jdem846.ui.projectPane.add.image.loadFailed.title"), JOptionPane.ERROR_MESSAGE);
			return;
		}
	...
	protected void addElevationDataset(final String filePath, final IRasterDefinition rasterDefinition, final boolean triggerModelChanged)
	{
		...
		try {
			...
			JOptionPane.showMessageDialog(instance.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.add.elevation.loadFailed.invalidFormat.message") + ": " + "", // ex.getExtension(),
					I18N.get("us.wthr.jdem846.ui.projectPane.add.elevation.loadFailed.invalidFormat.title"), JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(instance.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.add.shapeData.loadFailed.invalidFormat.message") + ": " + "", // ex.getExtension(),
					I18N.get("us.wthr.jdem846.ui.projectPane.add.shapeData.loadFailed.invalidFormat.title"), JOptionPane.ERROR_MESSAGE);
		}
	...
	public void moveDataSetToPosition(int type, int fromIndex, int toIndex)
	{
		...
		try {
			...
			JOptionPane.showMessageDialog(this.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.moveDataSetToPosition.moveError.message") + ": " + ex.getMessage(), I18N
					.get("us.wthr.jdem846.ui.projectPane.moveDataSetToPosition.moveError.title"), JOptionPane.ERROR_MESSAGE);
		}
		onDataModelChanged();
	}
	...
	public void onCreateModel()
	{
		...
		try {
			...
			JOptionPane.showMessageDialog(this.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.onCreateModel.copyDataRasterFailure.message") + ": " + ex.getMessage(), I18N
					.get("us.wthr.jdem846.ui.projectPane.onCreateModel.copyDataRasterFailure.title"), JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(this.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.onCreateModel.copyShapeDataFailure.message") + ": " + ex.getMessage(), I18N
					.get("us.wthr.jdem846.ui.projectPane.onCreateModel.copyShapeDataFailure.title"), JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(this.getRootPane(), I18N.get("us.wthr.jdem846.ui.projectPane.onCreateModel.copyImageDataFailure.message") + ": " + ex.getMessage(), I18N
					.get("us.wthr.jdem846.ui.projectPane.onCreateModel.copyImageDataFailure.title"), JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		modelProcessManifest.getGlobalOptionModel().setGetStandardResolutionElevation(JDem846Properties.getBooleanProperty("us.wthr.jdem846.rendering.standardResolutionRetrieval"));
		modelProcessManifest.getGlobalOptionModel().setInterpolateData(JDem846Properties.getBooleanProperty("us.wthr.jdem846.rendering.interpolateToHigherResolution"));
		modelProcessManifest.getGlobalOptionModel().setAverageOverlappedData(JDem846Properties.getBooleanProperty("us.wthr.jdem846.rendering.averageOverlappedData"));
		...
		try {
			modelContextCopy = ModelContext.createInstance(rasterDataContext, shapeDataContext, imageDataContext, null, modelProcessManifest, scriptingContext);
		} catch (ModelContextException ex) {
			// TODO: Display error dialog
	...
	protected void saveTo(String saveTo)
	{
		try {
			...
			JOptionPane.showMessageDialog(getRootPane(), I18N.get("us.wthr.jdem846.ui.jdemFrame.saveError.writeError.message"), I18N.get("us.wthr.jdem846.ui.jdemFrame.saveError.writeError.title"), JOptionPane.ERROR_MESSAGE);
			return;
		}
	}
