...
public class ModelConfigurationPanel extends Panel implements OptionModelChangeListener, ModelConfigurationChangeListener, OptionModelUIControl
{
	...
	public ModelConfigurationPanel(ModelContext modelContext, ModelProcessManifest modelProcessManifest, List<OptionModel> providedOptionModelList)
	{
		...
		// for (ModelProcessContainer modelProcessContainer :
		// modelProcessManifest.getProcessList()) {
	...
	public ModelProcessManifest getModelProcessManifest() throws Exception
	{
		...
		// String defaultLoadProcessor =
		// JDem846Properties.getProperty("us.wthr.jdem846.ui.options.modelConfiguration.loadProcessor.default");
		// String defaultSurfaceNormalsProcessor =
		// JDem846Properties.getProperty("us.wthr.jdem846.ui.options.modelConfiguration.normalsProcessor.default");
		// String defaultShapesProcessor =
		// JDem846Properties.getProperty("us.wthr.jdem846.ui.options.modelConfiguration.shapesProcessor.default");
