...
public class BufferControlledRasterDataContainer extends RasterDataContext
{
	...
	public void checkBuffer(double latitude, double longitude)
	{
		...
		if (tiledBuffering) {
			if (latitude <= nextCachePoint) {
				...
				// double southCache = (latitude - cacheHeight -
				// latitudeResolution) + (cacheHeight * 0.5);
				double northCache = nextCachePoint + (cacheHeight * 0.5);
	...
	public double getData(double latitude, double longitude, boolean avgOfAllRasterValues, boolean interpolate, boolean scaled) throws DataSourceException
	{
		...
		return rasterDataContext.getData(latitude, longitude, avgOfAllRasterValues, interpolate, scaled);
	}
	...
	public double getDataStandardResolution(double latitude, double longitude, boolean avgOfAllRasterValues, boolean interpolate) throws DataSourceException
	{
		...
		return rasterDataContext.getDataStandardResolution(latitude, longitude, avgOfAllRasterValues, interpolate);
	}
	...
	public double getDataStandardResolution(double latitude, double longitude, boolean avgOfAllRasterValues, boolean interpolate, boolean scaled) throws DataSourceException
	{
		...
		return rasterDataContext.getDataStandardResolution(latitude, longitude, avgOfAllRasterValues, interpolate, scaled);
	}
	...
	public double getDataAtEffectiveResolution(double latitude, double longitude, boolean avgOfAllRasterValues, boolean interpolate) throws DataSourceException
	{
		...
		return rasterDataContext.getDataAtEffectiveResolution(latitude, longitude, avgOfAllRasterValues, interpolate);
	}
	...
	public double getDataAtEffectiveResolution(double latitude, double longitude, boolean avgOfAllRasterValues, boolean interpolate, boolean scaled) throws DataSourceException
	{
		...
		return rasterDataContext.getDataAtEffectiveResolution(latitude, longitude, avgOfAllRasterValues, interpolate, scaled);
	}
